...
namespace SupremeFiction.UI.SupremeRulerModdingTool.WinForm.HotKey
{
    ...
    public class GlobalHotKey : INotifyPropertyChanged, ISerializable, IEquatable<GlobalHotKey>
    {
        ...
        {
            return string.Format("{0} ; {1} ; {2}Enabled ; GlobalHotKey", Name,
                HotKeyShared.CombineShortcut(Modifier, Key), Enabled ? "" : "Not ");
        }
    ...
    public class LocalHotKey : ISerializable, IEquatable<LocalHotKey>, IEquatable<ChordHotKey>
    {
        ...
        public override bool Equals(object obj)
        {
            var hotKey = obj as LocalHotKey;
            if (hotKey != null)
                return Equals(hotKey);

            var chotKey = obj as ChordHotKey;
            if (chotKey != null)
        ...
        public string FullInfo()
        {
            return string.Format("{0} ; {1} ; {2} ; {3}Enabled ; LocalHotKey", Name,
                HotKeyShared.CombineShortcut(Modifier, Key), WhenToRaise, Enabled ? "" : "Not ");
        }
    ...
    public class ChordHotKey : ISerializable, IEquatable<ChordHotKey>, IEquatable<LocalHotKey>
    {
        ...
        public override bool Equals(object obj)
        {
            var lhotKey = obj as LocalHotKey;
            if (lhotKey != null)
                return Equals(lhotKey);

            var hotkey = obj as ChordHotKey;
            if (hotkey != null)
                return Equals(hotkey);
        ...
        public string FullInfo()
        {
            ...
            return
                (String.Format("{0} ; {1} ; {2} ; {3}Enabled ; ChordHotKey", Name, bhot, chot, Enabled ? "" : "Not "));
        }
