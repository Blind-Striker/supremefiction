...
namespace SupremeFiction.UI.SupremeRulerModdingTool.WinForm.HotKey
{
    ...
    public static class HotKeyShared
    {
        ...
        public static object[] ParseShortcut(string text)
        {
            ...
            var Modifier = Modifiers.None; //Variable to contain modifier.
        ...
        {
            private readonly List<Modifiers> Enumeration;
            public bool HasAlt;
            ...
            public ParseModifier(int Modifier)
            {
                ...
                switch (Modifier)
                {
                    ...
                    case 15:
                        ...
                        break;
                    default:
                        throw new ArgumentOutOfRangeException("The argument is parsed is more than the expected range",
                            "Modifier");
                }
            }
